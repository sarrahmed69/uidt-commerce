...
const SignIn = () => {
  ...
  const onSubmit = async (data: SignInFormData) => {
    ...
    try {
      ...
      if (response?.success) {
        toast.success("Connexion reussie ! Bienvenue sur UIDT Commerce.");
  ...
  return (
    <AuthLayout title="Connexion" subtitle="Entrez vos identifiants pour acceder a votre compte UIDT Commerce">
