...
const HeroItem = () => {
  return (
    <div className="w-full h-full relative overflow-hidden rounded-sm bg-[#0a2a1f]">
      ...
      <div className="absolute inset-0 flex flex-col justify-center px-10 md:px-16 max-w-2xl">
        <motion.span
          ...
          <TbShoppingBag size={14} /> Campus Marketplace — UIDT
        </motion.span>
        ...
        <motion.p
          ...
          Rejoignez la marketplace des etudiants de l UIDT. Produits, services, livraison campus.
        </motion.p>
