        ...
        <div className="flex items-center gap-1 bg-gray-100 rounded-xl p-1">
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-semibold transition-all ${
              tab === "recent" ? "bg-white text-[#2B3090] shadow-sm" : "text-gray-500 hover:text-gray-700"
            }`}
          >
          ...
          <button
            ...
            className={`flex items-center gap-1.5 px-4 py-2 rounded-lg text-sm font-semibold transition-all ${
              tab === "popular" ? "bg-white text-[#2B3090] shadow-sm" : "text-gray-500 hover:text-gray-700"
            }`}
          >
