        ...
        {items.length === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 items-start">
            ...
            <div className="space-y-3">
              ...
              <button onClick={clearCart} className="text-xs text-red-400 hover:text-red-500 font-medium">
                Vider le panier
              </button>

              {/* Infos livraison */}
              <div className="bg-white rounded-2xl shadow-sm p-4 space-y-3">
                <h2 className="font-bold text-gray-800 text-sm">Informations de livraison</h2>
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <input
                      className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-9 pr-4 py-3 text-sm outline-none focus:ring-2 focus:ring-primary/20"
                      placeholder="Telephone (+221 77...)"
                      value={telephone}
                      onChange={e => setTelephone(e.target.value)}
                    />
                  </div>
                  <div className="relative">
                    <TbMapPin className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" size={16} />
                    <input
                      className="w-full bg-gray-50 border border-gray-200 rounded-xl pl-9 pr-4 py-3 text-sm outline-none focus:ring-2 focus:ring-primary/20"
                      placeholder="Batiment / Chambre / Adresse"
                      value={adresse}
                      onChange={e => setAdresse(e.target.value)}
                    />
                  </div>
                  <textarea
                    className="w-full bg-gray-50 border border-gray-200 rounded-xl px-4 py-3 text-sm outline-none focus:ring-2 focus:ring-primary/20 resize-none"
                    rows={2}
