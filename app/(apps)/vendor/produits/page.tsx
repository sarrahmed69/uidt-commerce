...
import { TbPlus, TbPackage, TbPencil, TbTrash, TbLoader2, TbEye, TbSearch, TbPhoto, TbLock, TbCreditCard, TbTag, TbX } from "react-icons/tb";
...
export default function MesProduits() {
  ...
  const deleteProduct = async (id: string) => {
    ...
    try {
      ...
      await (createClient()).from("orders").delete().eq("vendor_id", id);
