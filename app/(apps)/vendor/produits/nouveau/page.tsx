              ...
              <div>
                <div className="flex items-center justify-between mb-1.5">
                  ...
                  <button onClick={generateDescription} disabled={aiLoading || !form.nom}
                    className="flex items-center gap-1.5 bg-gradient-to-r from-[#2B3090] to-indigo-500 text-white text-xs font-bold px-3 py-1.5 rounded-lg hover:opacity-90 transition-all disabled:opacity-50 shadow-sm">
                ...
                <div className="relative">
                  ...
                  {aiLoading && (
                    <div className="absolute inset-0 bg-white/80 rounded-xl flex items-center justify-center">
                      <div className="flex items-center gap-2 text-[#2B3090] font-semibold text-sm">
