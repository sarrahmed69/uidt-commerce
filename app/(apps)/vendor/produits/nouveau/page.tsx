...
export default function NouveauProduitPage() {
  ...
  // Verification abonnement au chargement
  useEffect(() => {
    (async () => {
  ...
  const handleImages = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    newFiles.forEach((file) => {
      ...
      reader.onload = (ev) => {
        setPreviews((prev) => [...prev, ev.target?.result as string].slice(0, 4));
      };
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Double verification cote client avant envoi
      const { data: vendor } = await supabase
        .from("vendors")
  ...
  // Boutique suspendue — acces bloque
  if (suspended) return (
      ...
      <div className="bg-white rounded-3xl shadow-xl w-full max-w-md overflow-hidden">
        ...
        <div className="p-6 space-y-4 text-center">
          <p className="text-gray-600 text-sm">
            Vous ne pouvez pas ajouter de produits car votre boutique est suspendue.
      ...
      <aside className="w-64 bg-white border-r border-gray-100 fixed h-full hidden lg:flex flex-col">
        <div className="p-5 border-b border-gray-100">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-bold text-gray-800 text-sm">Ma Boutique</p>
          ...
          <div className="lg:col-span-2 space-y-5">
            <div className="bg-white rounded-2xl p-6 shadow-sm">
              <h2 className="font-semibold text-gray-800 mb-4 flex items-center gap-2">
                <TbPhoto className="text-primary" size={20} /> Photos du produit
              </h2>
            ...
            <div className="bg-white rounded-2xl p-6 shadow-sm space-y-4">
              <h2 className="font-semibold text-gray-800 flex items-center gap-2">
                <TbTag className="text-primary" size={20} /> Informations de base
              </h2>
              <div>
              ...
              <div>
                ...
                <textarea className={inputClass + " resize-none"} rows={4} placeholder="Decrivez votre produit..." value={form.description} onChange={(e) => set("description", e.target.value)} />
          ...
          <div className="space-y-5">
            <div className="bg-white rounded-2xl p-6 shadow-sm sticky top-6">
              ...
              <div className="rounded-xl overflow-hidden border border-gray-100 mb-4">
                {previews[0] ? (
                  <img src={previews[0]} alt="" className="w-full aspect-square object-cover" />
                ) : (
