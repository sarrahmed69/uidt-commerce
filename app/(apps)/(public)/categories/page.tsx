...
export default function CategoriesPage() {
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Hero */}
      <div className="bg-gradient-to-r from-[#1A1F6B] to-[#2B3090] text-white py-12 px-4 text-center">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
          {categories.map((cat) => (
            <Link key={cat.name}
              ...
              <div className="flex items-center gap-1 text-xs text-[#2B3090] font-semibold mt-auto">
