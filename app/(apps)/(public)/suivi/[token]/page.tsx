...
export default function SuiviPage() {
  ...
  useEffect(() => {
    (async () => {
      ...
      // Temps reel
      const channel = supabase.channel("suivi-" + token)
        .on("postgres_changes", {
    ...
    <div className="min-h-screen bg-[#F7F8FD]">
      ...
      <div className="max-w-lg mx-auto px-4 py-6 space-y-4">
        ...
        <div className={"rounded-2xl p-5 text-center border " +
          (step === 2 ? "bg-emerald-50 border-emerald-200" : step === 1 ? "bg-blue-50 border-blue-200" : "bg-amber-50 border-amber-200")}>
              ...
              <div key={s.key} className="flex gap-4">
                <div className="flex flex-col items-center">
                  <div className={"w-9 h-9 rounded-full flex items-center justify-center flex-shrink-0 border-2 " +
                    (done ? "bg-[#2B3090] border-[#2B3090]" : "bg-white border-gray-200")}>
        ...
        <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm space-y-4">
          ...
          <div className="space-y-2 text-sm">
            ...
            <div className="flex justify-between"><span className="text-gray-400">Date</span>
