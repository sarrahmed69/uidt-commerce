 ...
 * - pending   : en attente de validation par l'admin UAM
...
export const vendorTable = pgTable("vendors", {
  ...
  type: vendorTypeEnum("type").notNull().default("student"),
  ufr: varchar("ufr", { length: 100 }),                             // ex: "FST", "FDSP"
  studentId: varchar("student_id", { length: 50 }),                 // Numéro matricule UAM
