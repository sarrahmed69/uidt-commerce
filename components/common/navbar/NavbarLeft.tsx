    ...
    <div className="flex justify-center items-center sm:gap-x-5 gap-x-2">
      ...
      <Link href={profileLink} title="Profil" aria-label="Profil">
        <div className="flex items-center gap-x-2 relative ml-1 md:ml-0">
          {user ? (
            <>
              <TbUserCheck size={20} className="text-[#2B3090]" />
              {!isMobile && (
                <span className="capitalize text-sm font-semibold text-[#2B3090] max-w-[80px] truncate whitespace-nowrap">
            ...
            <>
              <AiOutlineUser size={20} className="text-[#2B3090]" />
              {!isMobile && <span className="text-sm font-semibold text-[#2B3090] whitespace-nowrap">Compte</span>}
            </>
          )}
        </div>
      </Link>
      ...
      <Link href="/cart" title="Panier" aria-label="Panier">
        <div className="flex items-center gap-x-2 relative ml-1 md:ml-0">
          <div className="relative">
            <TbShoppingCart size={22} className="text-[#2B3090]" />
            {cartCount > 0 && (
          ...
          {!isMobile && <span className="text-sm font-semibold text-[#2B3090] whitespace-nowrap">Panier</span>}
        </div>
      </Link>
